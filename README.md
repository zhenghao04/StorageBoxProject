...
- 右键盒子可添加文件/应用、添加文件夹、重命名、调整外观、新建盒子、删除盒子、切换置顶、开机自启动、设置和退出
- 托盘菜单支持新建盒子、切换置顶、开机自启动、打开配置文件夹、设置和退出
- 3x3 面板带轻量淡入/缩放动画，开关更顺滑
- 内置清透浅色、深色玻璃、暖砂柔光、极简白四套界面主题
...
- 开机启动时会先显示盒子，再延后托盘初始化和必要配置保存，减少启动阶段阻塞
